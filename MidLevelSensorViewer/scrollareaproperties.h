...
{
public:
    QHBoxLayout *CreateQHBoxLayout(QString first_text, int t_width,
                                   int t_height, QString style);
    QHBoxLayout *CreateQHBoxLayout(QString first_text, QString second_text,
    ...
    QHBoxLayout *CreateQHBoxLayout(QString first_text, QString second_text,
                                   ...
                                   int t_height, QString style);
    QLabel *CreateQLabel(QString text, int t_width,
                         int t_height, QString style);
};
